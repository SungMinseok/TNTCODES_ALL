...
public class Trig18 : MonoBehaviour
{
    //수정//////////////////////////////////////////////////////////////////    Dialogue or Select ( 각 항목 개수는 무제한이고 단 Select에서 선택지 4개가 최대 )
    public static Trig18 instance;
    public int trigNum;
...
//        theBook= BookManager.instance;
        ...
        if(theDB.trigOverList.Contains(16)){//트리거 실행 후 맵에 다시 돌아왔을 때 DB list에 들어가 있으면 다시 실행 안됨.
            flag = true;
        }
    ...
    private void OnTriggerStay2D(Collider2D collision){
        ...
        if(!theDB.trigOverList.Contains(16)){
