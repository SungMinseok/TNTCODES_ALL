...
public class Trig38 : MonoBehaviour
{
    ...
    public GameObject trig37;
    public GameObject trig40;
    ...
    public IEnumerator FinishGame(){
            ...
            trig40.GetComponent<Trig27>().flag = false;
            Debug.Log("업적7 : 꼼꼼한 편");
            
            if(SteamAchievement.instance!=null) SteamAchievement.instance.ApplyAchievements(7);
    }
}
