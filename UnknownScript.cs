...
public class UnknownScript : MonoBehaviour
{
    ...
    public void WalkSound(){
        if(mother.activated){
            ...
            // AudioManager.instance.Play("falldown"+temp.ToString());
    ...
    public IEnumerator DestroyUnknown(){
        ...
        mother.activated = false;
        Debug.Log("언노운 파괴");
        FadeManager.instance.UnknownFogOff();
        //StartCoroutine(FadeManager.instance.UnknownFogOff());
        shadow.SetActive(false);
    ...
    public void GameOver(){
        ...
        if(DatabaseManager.instance.caughtCount>=10){
            Debug.Log("업적5 : 이제 그만");
            
            if(SteamAchievement.instance!=null) SteamAchievement.instance.ApplyAchievements(5);
        }
        FadeManager.instance.unknownFog.SetActive(false);
