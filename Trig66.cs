...
public class Trig66 : MonoBehaviour
{
    ...
    //public GameObject[] mats = new GameObject[3];
    ...
    private void OnTriggerStay2D(Collider2D collision){
        ...
        if(!theDB.puzzleOverList.Contains(3)&&!thePlayer.isPlayingPuzzle){
    ...
    IEnumerator EventCoroutine(){
        ...
        if(bifur==0){
            ...
            // if(theSelect.GetResult()==0){
                ...
                PuzzleManager.instance.puzzleNum[3].SetActive(true);
